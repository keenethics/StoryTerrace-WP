...
?>
        <div class="grid-container">
            ...
            <div  class="checkout-progress">
              <div class="step step1 success active"><span>1</span> <?php if(!empty($payment_text_plan)) { echo $payment_text_plan; } else{ ?>Choose Payment Plan <?php } ?></div>
        <div class="step step2 active"><span>2</span> <?php if(!empty($shipping_text_plan)) { echo $shipping_text_plan; } else{ ?>Shipping / Payment Details <?php } ?></div>
      ...
      <div class="product-footer">
          ...
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 continue-checkout">
            ...
            <div class="learn-more-affirm"><span>Or</span> <p id="learn-more" class="affirm-as-low-as" data-amount="<?php echo $woocommerce->cart->total * 100; ?>" data-affirm-color="blue" data-learnmore-show="true" data-page-type="product"></p>
            <a class="btn-gotocart"  href="#">Complete</a></div>
          </div>
      </div> 
    <?php }else{ ?>
        <div class="product-footer">
