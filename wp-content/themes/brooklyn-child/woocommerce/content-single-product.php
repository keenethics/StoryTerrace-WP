...
if($lang == 'en-US'){ ?>
  <style type="text/css">
    .wc-pao-addon.wc-pao-addon-choose-additional-copies, .wc-pao-addon.wc-pao-addon-chapters,.btn-gotocart.cartload{
      display: block !important;
    }
    .woocommerce-variation-add-to-cart.variations_button.woocommerce-variation-add-to-cart-enabled{
      display: block !important;
    }
    .btn-request, .btn-continue{
...
<?php }else{ ?>
  <style type="text/css">
    .wc-pao-addon.wc-pao-addon-choose-additional-copies,.wc-pao-addon.wc-pao-addon-extra-exemplaaren ,.wc-pao-addon.wc-pao-addon-chapters,.wc-pao-addon.wc-pao-addon-extra-copies, .wc-pao-addon.wc-pao-addon-exemplaaren{
      display: block !important;
    }
  </style>
<?php } ?>
